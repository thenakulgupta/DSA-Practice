/*
    Probleam: K’th largest element in a stream.
...
public:
    ...
    vector<int> findLargestElements(vector<Rows*>v, int k) {
        vector<int> result;
...
int main() {
    ...
    */
    ...
    vector<int> result = heap->findLargestElements(v, k);
    heap->print(result);
    return 0;
}
